...
//    self.appBarViewController.headerView.trackingScrollView = self.collectionView
    ...
    //TODO: Register for the catalog changed notification
      NotificationCenter.default.addObserver(self, selector: #selector(respondToCatalogNotification), name: Notification.Name(rawValue: "CatalogFilterDidChangeNotification"), object: nil)
  }
